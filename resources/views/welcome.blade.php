...
<div class="text-center py-20">
    <h1 class="text-4xl font-heycomic font-bold mb-4">Selamat Datang di Modyan</h1>
    <p class="text-lg text-gray-300 mb-8">Catat suasana hati dan pikiran Anda setiap hari dengan mudah.</p>
    @guest
